                                        ...
                                        function deleteDirectoryRecursively(dirPath) {
                                            fs.readdir(dirPath, (err, files) => {
                                                ...
                                                files.forEach(file => {
                                                    ...
                                                    fs.stat(fullPath, (err, stats) => {
                                                        ...
                                                        if (stats.isDirectory()) {
                                                            ...
                                                            // Check if the file is not in files.json and its base directory is not whitelisted
                                                            if (!filesToKeep.has(relativeFilePath) && !directoriesToKeep.has(baseDir)) {
                                                ...
                                                fs.readdir(dirPath, (err, remainingFiles) => {
                                                    ...
                                                    if (remainingFiles.length === 0 && !directoriesToKeep.has(path.relative(minecraftPath, dirPath))) {
